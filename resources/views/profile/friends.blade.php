...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <h4 class="card-heading" style="margin-top:20px;text-align:center;">{{Auth::user()->name}}'s Friends</h4>
            </div>
                <div class="card-body">
                    <div class="col-sm-12 col-md-12">
                        ...
                        <div class="row" style="border-bottom:1px solid #ccc; margin-bottom:15px">
                            ...
                            <div class="col-md-7 pull-left">
                                <h3 style="margin-left:10px;"><a href="{{url('/profile')}}/{{$uList->slug}}">{{ucwords($uList->name)}}</a></h3>
