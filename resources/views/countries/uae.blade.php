...
<div class="list-group">
  <h4 class="list-group-item list-group-item-action"><center>Select any of the place from <b>UAE</b></center></h4>
  
  <a href="{{url('/home/countries/uae/dubai')}}" class="list-group-item list-group-item-action list-group-item-success">Dubai</a>
