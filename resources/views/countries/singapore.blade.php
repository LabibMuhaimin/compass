...
<div class="list-group">
  <h4 class="list-group-item list-group-item-action"><center>Select any of the place from <b>Singapore</b></center></h4>
  
  <a href="{{url('/home/countries/singapore/gardenbay')}}" class="list-group-item list-group-item-action list-group-item-success">Gardens by the Bay</a>
