...
<div class="list-group">
  <h4 class="list-group-item list-group-item-action"><center>Select any of the place from <b>Nepal</b></center></h4>
  
  <a href="{{url('/home/countries/nepal/himalaya')}}" class="list-group-item list-group-item-action list-group-item-success">Himalayas</a>
