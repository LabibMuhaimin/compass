...
<div class="list-group">
  <h4 class="list-group-item list-group-item-action"><center>Select any of the place from <b>Egypt</b></center></h4>
  
  <a href="{{url('/home/countries/egypt/cairo')}}" class="list-group-item list-group-item-action list-group-item-success">Cairo</a>
