...
<div class="list-group">
  <h4 class="list-group-item list-group-item-action"><center>Select any of the place from <b>Spain</b></center></h4>
  
  <a href="{{url('/home/countries/spain/barcelona')}}" class="list-group-item list-group-item-action list-group-item-success">Barcelona</a>
