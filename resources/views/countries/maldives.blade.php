...
<div class="list-group">
  <h4 class="list-group-item list-group-item-action"><center>Select any of the place from <b>Maldives</b></center></h4>
  
  <a href="{{url('/home/countries/maldives/addu')}}" class="list-group-item list-group-item-action list-group-item-success">Addu Atoll</a>
